...
function generateLastRecap() {
  ...
  const ourScore = lastT.our_total_goals !== undefined ? lastT.our_total_goals : 0;
  const oppScore = lastT.opponent_total_goals !== undefined ? lastT.opponent_total_goals : 0;
